...
export default function Sidebar({ isExpanded = true, onToggle }: SidebarProps) {
            ...
            <div className="flex flex-col items-start self-stretch relative">
              ...
              {menuItems.map((item) => (
                ...
                <div
                  ...
                  className={`flex items-center text-white self-stretch relative cursor-pointer transition-all duration-200 hover:bg-blue-500/10 ${activeItem === item.id ? 'bg-blue-500/20' : ''}`}
  ...
  function ReviewIcon() {
    ...
    return (
      ...
      <img src="image/icons/review.svg" alt="Review Icon" />
